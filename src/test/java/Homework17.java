...
public class Homework17 extends BaseTest {
    ...
    public static void addSongToPlaylist() throws InterruptedException {
        ...
        String newSongAddedNotificationText = "Added 1 song into Test";
    ...
    public static void clickViewAllButton () throws InterruptedException {
        WebElement viewAllSearchResult = driver.findElement(By.cssSelector("div.results section.songs h1 button")); //  //button[@data-test='view-all-songs-btn']
    ...
    public static void clickAddToButton() throws InterruptedException {
        WebElement addToButton = driver.findElement(By.cssSelector("button.btn-add-to")); ////button[@data-test='add-to-btn']
        addToButton.click();
        Thread.sleep(3000);
    }

    public static void choosePlaylist () throws InterruptedException {
//        Write xPath for playlist where song will be added
